...
function FacebookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14 21v-8h3l.5-3H14V8.2c0-1.4.5-2.2 2.2-2.2H18V3.3c-.5-.1-1.4-.2-2.3-.2-2.3 0-3.7 1.4-3.7 4V10H9v3h3v8" />
    </svg>
  );
}
...
function TikTokIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14 3v11.3a4.1 4.1 0 1 1-3.2-4" />
      <path d="M14 3c.6 2.8 2.2 4.3 5 4.6" />
    </svg>
  );
}
...
function configuredLinks(
  ...
  if (settings) {
    ...
    add(
      'tiktok',
      externalUrl(settings.tiktok_url),
      'TikTok',
      'Follow us on TikTok',
    );
  }
